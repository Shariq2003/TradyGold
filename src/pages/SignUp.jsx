...
const SignUp = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-400 to-green-500 p-20">
            {/* Toast Container */}
            <ToastContainer
                position="top-center"
                autoClose={5000}
                    ...
                    <form className="space-y-4" onSubmit={handleSignUp}>
                        ...
                        <div className="animate-slideInRight">
                            ...
                            {isChecking ? (
                                ...
                                <p
                                    className={`mt-2 text-sm ${message.includes('available')
                                            ? "text-green-600"
                        ...
                        <div className="animate-slideInLeft">
                            ...
                            {isChecking ? (
                                ...
                                <p
                                    className={`mt-2 text-sm ${emailMessage.includes('available')
                                            ? "text-green-600"
